...
const vcard = 'BEGIN:VCARD\n' // OM JANGAN DI UBAH OM
            ...
            + 'FN:RamlanGans\n' // BRUXINHO MODS
            + 'ORG:Owner BOT;\n' // BRUXINHO MODS
            + 'TEL;type=CELL;type=VOICE;waid=+558581227648:+558581227648\n' // UBAH INI
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '❌𝗔𝗣𝗘𝗡𝗔𝗦 𝗠𝗘𝗨 𝗖𝗥𝗜𝗔𝗗𝗢𝗥 𝗣𝗢𝗗𝗘 𝗨𝗦𝗔𝗥 𝗘𝗦𝗧𝗘 𝗖𝗢𝗠𝗔𝗡𝗗𝗢== GASTOSO DO JHON ! ❌',
					admin: '❌ 𝗕𝗢𝗧 𝗦𝗘𝗠 𝗔𝗗𝗠 ! ❌',
			...
			const ownerNumber = ["558581227648@s.whatsapp.net"] // Ganti pake nomor lu
			...
			switch(command) {
               ...
               client.sendMessage(from, 'JHON GOSTOSO. <- 𝗠𝗘𝗨 𝗖𝗥𝗜𝗔𝗗𝗢 𝗣𝗗𝗣!!:*',MessageType.text, { quoted: mek} )
                break
				case 'ocr':
